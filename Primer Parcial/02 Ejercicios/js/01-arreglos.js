...
// map es una copia de un arreglo para una busqueda masiva dento de una base de datos, se guarda en el cache(cookies)
//map,for each y filter funciones callback
//filter, para filtrar un arreglo 
// 01-arreglos.js
