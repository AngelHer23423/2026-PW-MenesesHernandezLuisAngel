...
console.log(`Manejo de valores en un onjeto`);
...
const textoJason = JSON.stringify(taller, null, 2);
console.log(textoJason);
...
console.log('Ahora JSON a Objeto');
const objetoDeVuelta = JSON.parse(textoJason);
